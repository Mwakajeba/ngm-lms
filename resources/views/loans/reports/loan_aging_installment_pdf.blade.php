    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 7%;">Installment</th>
        ...
        <tbody>
            ...
            @forelse($agingData as $index => $row)
                @php
                    ...
                    $totalInstallment += $row['installment_amount'] ?? 0;
                ...
                <tr>
                    ...
                    <td class="text-right">{{ number_format($row['installment_amount'], 0) }}</td>
            ...
            <tr class="total-row">
                ...
                <td class="text-right"><strong>{{ number_format($totalInstallment, 0) }}</strong></td>
                <td colspan="4"></td>
