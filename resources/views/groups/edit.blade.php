                            ...
                            <form action="{{ route('groups.update', Hashids::encode($group->id)) }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="loan_officer" class="form-select @error('loan_officer') is-invalid @enderror" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="meeting_day" class="form-select @error('meeting_day') is-invalid @enderror" required>
