...
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <h6 class="mb-0 text-uppercase">EDIT SUBSCRIPTION</h6>
            <hr />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea class="form-control" id="plan_description" name="plan_description"
                                            rows="3"
                                            placeholder="Describe the plan features and benefits">{{ old('plan_description', $subscription->plan_description) }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select" id="currency" name="currency" required>
                                            <option value="TZS" {{ old('currency', $subscription->currency) == 'TZS' ? 'selected' : '' }}>TZS</option>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select" id="billing_cycle" name="billing_cycle" required>
                                            ...
                                            <option value="monthly" {{ old('billing_cycle', $subscription->billing_cycle) == 'monthly' ? 'selected' : '' }}>Monthly
                                            </option>
                                            <option value="quarterly" {{ old('billing_cycle', $subscription->billing_cycle) == 'quarterly' ? 'selected' : '' }}>Quarterly
                                            </option>
                                            <option value="half-yearly" {{ old('billing_cycle', $subscription->billing_cycle) == 'half-yearly' ? 'selected' : '' }}>
                                                Half-Yearly</option>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="auto_renew"
                                                name="auto_renew" value="1" {{ old('auto_renew', $subscription->auto_renew) ? 'checked' : '' }}>
