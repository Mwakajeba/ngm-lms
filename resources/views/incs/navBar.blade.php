...
<nav class="navbar navbar-expand gap-3">
	...
	<div class="top-menu-left d-none d-lg-block">
 	 <ul class="nav">
		...
		<li class="nav-item">
		  <a class="nav-link position-relative" href="javascript:;" data-bs-toggle="modal" data-bs-target="#loanMessagesModal" title="Loan Messages & Notifications">
			<i class='bx bx-message'></i>
			<span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" id="messageNotificationBadge" style="display: none;">
				0
			</span>
		  </a>
		</li>
		<li class="nav-item">
		  <a class="nav-link" href="javascript:;" data-bs-toggle="modal" data-bs-target="#calendarModal"><i class='bx bx-calendar'></i></a>
		</li>
		<li class="nav-item">
			<a class="nav-link" href="javascript:;" data-bs-toggle="modal" data-bs-target="#tasksModal" title="Task Manager">
			...
			<li class="nav-item dropdown dropdown-large">
				...
				<div class="dropdown-menu dropdown-menu-end">
					<div class="row row-cols-3 g-3 p-3">
						...
						<div class="col text-center">
							<a href="javascript:;" data-bs-toggle="modal" data-bs-target="#calendarModal" class="text-decoration-none">
								<div class="app-box mx-auto bg-gradient-blues"><i class='bx bx-calendar'></i></div>
								<div class="app-title">Calendar</div>
							</a>
						</div>
						
						<div class="col text-center">
							<a href="javascript:;" data-bs-toggle="modal" data-bs-target="#tasksModal" class="text-decoration-none">
								<div class="app-box mx-auto bg-gradient-success"><i class='bx bx-check-square'></i></div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card border-success mb-3">
                    <div class="card-body">
                        <form id="addTaskForm">
                            <div class="row">
                                <div class="col-md-8">
                                    <input type="text" class="form-control form-control-lg" id="taskInput" placeholder="Enter a new task for today..." required>
                                </div>
                                <div class="col-md-4">
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="btn-group w-100" role="group">
                            ...
                            <input type="radio" class="btn-check" name="taskFilter" id="pendingTasks" value="pending">
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        <button type="button" class="btn btn-outline-secondary w-100 action-btn" id="clearCompleted">
...
<!-- Loan Messages Modal -->
<div class="modal fade" id="loanMessagesModal" tabindex="-1" aria-labelledby="loanMessagesModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                ...
                <div class="d-flex gap-2">
                    <button type="button" class="btn btn-outline-light btn-sm" onclick="loadMessages()" title="Refresh Messages">
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="btn-group w-100" role="group">
                            ...
                            <input type="radio" class="btn-check" name="messageFilter" id="arrearsAlerts" value="arrears">
                            <label class="btn btn-outline-danger" for="arrearsAlerts">
                                <i class="bx bx-error-circle me-2"></i>Arrears Alerts
                            </label>
                            
                            <input type="radio" class="btn-check" name="messageFilter" id="approvalRequests" value="approval">
