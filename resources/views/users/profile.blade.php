                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="password" class="form-control {{ isset($errors) && $errors->has('current_password') ? 'is-invalid' : '' }}" 
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="password" class="form-control {{ isset($errors) && $errors->has('new_password') ? 'is-invalid' : '' }}" 
                                        ...
                                        @endif
                                        <small class="form-text text-muted">Leave blank to keep current password. Must be at least 8 characters if changed.</small>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="password" class="form-control {{ isset($errors) && $errors->has('new_password_confirmation') ? 'is-invalid' : '' }}" 
