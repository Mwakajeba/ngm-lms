    ...
    <div class="col-12">
        <div class="form-section">
                ...
                <div class="col-md-4">
                    <div class="form-check form-switch mt-4">
                        <input class="form-check-input" type="checkbox" id="create_user_account" name="create_user_account" value="1"
                            {{ old('create_user_account', false) ? 'checked' : '' }}>
                        <label class="form-check-label" for="create_user_account">Create login user account</label>
                    </div>
                    <small class="text-muted">If unchecked, only the employee record is saved (no system login).</small>
                    @error('create_user_account')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                </div>
                @endif
            </div>
            ...
            <div class="alert alert-info mt-3 mb-0">
                ...
                <ul class="mb-0 mt-2">
                    <li>Optionally tick <strong>Create login user account</strong> if the employee needs system access (leave unchecked to save employee only)</li>
