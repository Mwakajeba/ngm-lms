                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="card module-card h-100">
                                        <div class="count-badge bg-danger">{{ number_format($stats['salary_advances']['total'] ?? 0) }}</div>
                                        <div class="card-body text-center">
                                            <div class="mb-3">
                                ...
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="card module-card h-100">
                                        <div class="count-badge bg-primary">{{ number_format($stats['external_loans']['total'] ?? 0) }}</div>
                                        <div class="card-body text-center">
                                            <div class="mb-3">
                                ...
                                {{-- Phase 2: Time, Attendance & Leave Management (hidden for now)
                                ...
                                {{-- Phase 5: Performance & Training (hidden for now)
                                <div class="col-12 mt-4">
                                ...
                                {{-- Phase 6: Employment Lifecycle Management (hidden for now)
                                <div class="col-12 mt-4">
                                ...
                                {{-- Phase 7: Discipline, Grievance & Exit (hidden for now)
                                <div class="col-12 mt-4">
