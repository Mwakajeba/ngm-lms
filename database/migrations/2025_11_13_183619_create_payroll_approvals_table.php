...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('payroll_approvals', function (Blueprint $table) {
            ...
            $table->decimal('amount_at_approval', 15, 2)->nullable(); // Store amount at time of approval
            ...
            $table->unique(['payroll_id', 'approval_level', 'approver_id'], 'payroll_approvals_unique_key');
        });
    }
